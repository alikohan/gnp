...
def crossover(individual1, individual2):
    """Perform standard crossover between two GNP individuals."""
...
def mutation(individual):
    """Apply standard mutation to a GNP individual."""
...
def run_GA(max_fitness_of_each_epoch):
    ...
    for i in range(epoch_number):
        ...
        for j in range((population_size // 2) - 1): # to hold 2 best
            ...
            crossovered = crossover(copy.deepcopy(individuals[selected_individual_index[0]]), copy.deepcopy(individuals[selected_individual_index[1]]))
