"""
Simplified GNP - Simplified Genetic Network Programming
"""
...
def crossover(individual1, individual2, sequence1, sequence2):
    """
...
def mutation(individual, sequence):
    """
...
def run_GA(max_fitness_of_each_epoch):
    ...
    for i in range(epoch_number):
        ...
        for j in range(2, len(new_individuals)): # hold 2 best
            mutation(new_individuals[j], sequences[j])
